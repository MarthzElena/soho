...
ChargeCustomerResponse chargeCustomerResponseFromJson(String str) =>
    ChargeCustomerResponse.fromJson(json.decode(str));

String chargeCustomerResponseToJson(ChargeCustomerResponse data) => json.encode(data.toJson());

class ChargeCustomerResponse {
  String id;
  String object;
  int amount;
  int amountRefunded;
  ...
  factory ChargeCustomerResponse.fromJson(Map<String, dynamic> json) => ChargeCustomerResponse(
        id: json["id"],
        object: json["object"],
        amount: json["amount"],
