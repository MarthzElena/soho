            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 0.0, top: 40, right: 0.0, bottom: 0.0),
                    child: Text('Nombre(s)'),
                  ),
                  TextField(
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 0.0, top: 15, right: 0.0, bottom: 0.0),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 0.0, top: 16.0, right: 0.0, bottom: 15.0),
                    child: SizedBox(
                      width: double.infinity,
                      child: RaisedButton(
